...
class CopyStashCommand(sublime_plugin.TextCommand):
  ...
  def run(self, edit):
    sublime.status_message("ASDASDASDS")
    return
    ...
    for project in projects as repolist:
      if matches[0] in repolist
        targetProject = project
        break

    url = 'https://stash.atg-corp.com/projects/' + targetProject + '/repos/' + matches[0] + '/browse' + matches[1];
